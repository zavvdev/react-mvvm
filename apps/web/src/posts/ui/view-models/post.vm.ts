...
export const usePostViewModel = ({ api }: VMDependencies) => {
...
export const postViewModel = () => inject<"api">("api")(usePostViewModel);
export type PostViewModel = ReturnType<typeof postViewModel>;
export type PostViewModelResult = ReturnType<ReturnType<typeof postViewModel>>;
