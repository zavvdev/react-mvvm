...
import { type AvailableBudgetDto, type CreateDto, type DeleteDto, type GetAllDto, type GetOneDto, type UpdateDto } from "./schemas";
export declare var createCategoriesApi: (http: Http) => {
    ...
    getAvailableBudget$: (dto: AvailableBudgetDto["Request"]) => import("rxjs").Observable<{
        status: "success" | "error";
        message: string;
        data: {
            isLimitless: boolean;
